...
| [aws_network_acl.serverless](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/network_acl) | resource |
...
| [aws_network_acl_rule.serverless_inbound](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/network_acl_rule) | resource |
| [aws_network_acl_rule.serverless_outbound](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/network_acl_rule) | resource |
...
| [aws_route_table.connect](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table) | resource |
...
| [aws_route_table_association.connect](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table_association) | resource |
...
| [aws_subnet.connect](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
...
| [aws_subnet.serverless](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
...
| <a name="input_connect_route_table_tags"></a> [connect\_route\_table\_tags](#input\_connect\_route\_table\_tags) | Additional tags for the connect route tables | `map(string)` | `{}` | no |
| <a name="input_connect_subnet_assign_ipv6_address_on_creation"></a> [connect\_subnet\_assign\_ipv6\_address\_on\_creation](#input\_connect\_subnet\_assign\_ipv6\_address\_on\_creation) | Assign IPv6 address on connect subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map\_public\_ip\_on\_launch | `bool` | `null` | no |
| <a name="input_connect_subnet_ipv6_prefixes"></a> [connect\_subnet\_ipv6\_prefixes](#input\_connect\_subnet\_ipv6\_prefixes) | Assigns IPv6 connect subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list | `list(string)` | `[]` | no |
| <a name="input_connect_subnet_suffix"></a> [connect\_subnet\_suffix](#input\_connect\_subnet\_suffix) | Suffix to append to connect subnets name | `string` | `"connect"` | no |
| <a name="input_connect_subnet_tags"></a> [connect\_subnet\_tags](#input\_connect\_subnet\_tags) | Additional tags for the connect subnets | `map(string)` | `{}` | no |
| <a name="input_connect_subnets"></a> [connect\_subnets](#input\_connect\_subnets) | A list of connect subnets inside the VPC | `list(string)` | `[]` | no |
...
| <a name="output_connect_route_table_association_ids"></a> [connect\_route\_table\_association\_ids](#output\_connect\_route\_table\_association\_ids) | List of IDs of the connect route table association |
