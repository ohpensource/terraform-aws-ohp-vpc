...
variable "connect_subnet_ipv6_prefixes" {
  description = "Assigns IPv6 connect subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list"
  type        = list(string)
  default     = []
}
...
variable "connect_subnet_assign_ipv6_address_on_creation" {
  description = "Assign IPv6 address on connect subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map_public_ip_on_launch"
  type        = bool
  default     = null
}
...
variable "connect_subnet_suffix" {
  description = "Suffix to append to connect subnets name"
  type        = string
  default     = "connect"
}
...
variable "connect_subnets" {
  description = "A list of connect subnets inside the VPC"
  type        = list(string)
  default     = []
}
...
variable "connect_subnet_tags" {
  description = "Additional tags for the connect subnets"
  type        = map(string)
  default     = {}
}
...
variable "connect_route_table_tags" {
  description = "Additional tags for the connect route tables"
  type        = map(string)
  default     = {}
}
